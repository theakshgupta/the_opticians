...
const SignupPage = () => {
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      fullName: "",
      phoneNumber: "",
      age: undefined, // Use undefined instead of empty string
      email: "",
      password: "",
      confirmPassword: "",
      acceptTerms: false,
  ...
  const onSubmit = (values: FormSchema) => {
    ...
    // TODO: handle submission logic, e.g. redirect after a successful signup
  };
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-full">
      ...
      {/* Right Section */}
      <div className="h-max w-full lg:w-1/2 rounded-2xl px-5 py-10 sm:p-10 md:p-16 flex flex-col gap-6">
        {/* Logo */}
        <Link href="/">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-3xl lg:text-5xl font-medium">Join Us Today</h1>
          <p className="text-gray-600 text-sm md:text-base font-light">
            Create an account and enjoy personalized recommendations, special
            discounts, and more.
          </p>
        </div>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <PhoneInput
                          ...
                          className="h-10 flex gap-1 border px-3 rounded-md shadow-sm focus-visible:ring-0 focus-visible:ring-offset-0"
