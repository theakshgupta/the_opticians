...
const ImageSlider: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Button
        onClick={prevSlide}
        className="absolute left-5 md:left-10 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full"
      >
        <ArrowLeft style={{ width: 20, height: 20 }} />
      </Button>
      <Button
        onClick={nextSlide}
        className="absolute right-5 md:right-10 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full"
      >
