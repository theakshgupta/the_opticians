...
interface ProductCarouselProps {
  title: string;
  products?: Product[]; // Optional to avoid undefined issues
  viewMoreLink?: string;
    ...
    <section className={className}>
      ...
      <div className="relative">
        ...
        <div
          ...
          className="overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-hide whitespace-nowrap flex gap-2 md:gap-4 border-r rounded-xl"
        >
          {products.length > 0 ? (
